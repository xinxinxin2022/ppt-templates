<template>
  <div class="py-12">
    <div class="max-w-7xl mx-auto px-4">
      ...
      <div v-else class="text-center py-12 text-gray-500"><p class="text-lg">{{ t('category.noResults') }}</p></div>
    </div>
  </div>
</template>
...
const currentInfo = computed(() => { const key = Object.keys(categoryInfo).find(k => k.toLowerCase() === slug.value); return key ? categoryInfo[key] : null })
